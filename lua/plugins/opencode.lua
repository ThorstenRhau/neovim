return {
    ...
    keys = {
        ...
        -- Ask/prompt
        { '<leader>oa', function() require('opencode').ask() end, mode = { 'n', 'x' }, desc = 'Ask opencode' },
        { '<leader>oA', function() require('opencode').ask('@this: ', { submit = true }) end, mode = { 'n', 'x' }, desc = 'Ask opencode about this' },

        -- Select from prompts/commands
        { '<leader>os', function() require('opencode').select() end, mode = { 'n', 'x' }, desc = 'Select opencode action' },

        -- Operator for ranges
        { 'go', function() return require('opencode').operator('@this ') end, expr = true, desc = 'Add range to opencode' },
        ...
        { '<leader>ou', function() require('opencode').command('session.undo') end, desc = 'Undo' },
        { '<leader>or', function() require('opencode').command('session.redo') end, desc = 'Redo' },
    },
    config = function()
